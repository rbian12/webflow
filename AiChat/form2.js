...
$(document).ready(function() {
    ...
    const submitBtn = $('#wf-form-IR-Form .btn-primary.submit');

    // on submit button click
    submitBtn.click((event) => {
        // get the email field
        const email = $('#Business-Email-Address-IR');
        const errorMessage = $('#error-email-ir');
    ...
    $('#Business-Email-Address-IR').on('input', function() {
        const email = $(this);
        const errorMessage = $('#error-email-ir');
